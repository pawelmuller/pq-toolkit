        ...
        <div>
            {deleteConfirm ? (
                <div className="flex flex-row mr-1">
                    <FaTimes aria-label="cancel-delete" className="fill-red-500 mr-2 cursor-pointer transform hover:scale-125 duration-300 ease-in-out" size={25} onClick={() => { setDeleteConfirm(false); }} />
                    <FaCheck aria-label="confirm-delete" className="fill-green-500 cursor-pointer transform hover:scale-125 duration-300 ease-in-out" size={24} onClick={() => {
                ...
                <FaTrash aria-label="delete-icon" className="fill-red-500 cursor-pointer mr-0 sm:mr-2 transform hover:scale-125 duration-300 ease-in-out" size={25} onClick={() => { setDeleteConfirm(true); }} />
            )}
        </div>
    );
};
