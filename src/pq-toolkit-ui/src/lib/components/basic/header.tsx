                ...
                <div className="w-full flex items-center justify-between h-20 pl-10 pr-10">
                    ...
                    <div className="flex content-center fadeInUp">
                        <a className="text-blue-400 no-underline hover:text-pink-500 hover:text-underline transform hover:scale-105 duration-300 ease-in-out" href="/about">
                            <svg className="fill-current h-9 md:h-10" xmlns="http://www.w3.org/2000/svg" width="80" viewBox="0 1 23 23">
                        ...
                        <a className="text-blue-400 no-underline hover:text-pink-500 hover:text-underline transform hover:scale-105 duration-300 ease-in-out" href="https://github.com/pawelmuller/pq-toolkit">
                            <svg className="fill-current h-8 md:h-9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                                <path
